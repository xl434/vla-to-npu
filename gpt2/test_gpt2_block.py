...
def run(x_fp32: np.ndarray, params: dict):
    ...
    linear_A_layout = [S(1), R]
    linear_B_layout = [R, S(0)]
    linear_C_layout = [S(1), S(0)]
    ...
    ATTN_SCORE_LyA = [S(1), R]
    ATTN_SCORE_LyB = [S(0), R]
    ATTN_SCORE_LyC = [S(1), S(0)]
