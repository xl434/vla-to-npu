...
def test_layer_norm_tiling():
    ...
    if is_available():
        ...
        try:
            ...
            print("PASSED layer norm tiling!")
        except AssertionError as e:
            print(f"MISMATCH (continuing): {e}")
            report_mismatches(
                output_allo.astype(np.float32),
...
def test_layer_norm_tiling_small():
    ...
    N = 192                 # hidden dimension per tile
    ...
    if is_available():
        ...
        try:
            ...
            print("PASSED layer norm tiling small!")
        except AssertionError as e:
            print(f"MISMATCH (continuing): {e}")
            report_mismatches(
                output_allo.astype(np.float32),
...
if __name__ == "__main__":
    # test_layer_norm()
    # test_layer_norm_tiling()
    test_layer_norm_tiling_small()