module {
  ...
  func.func @core_0_1(%arg0: memref<32x64xbf16>, %arg1: memref<32x64xbf16>, %arg2: memref<32x32xbf16>) attributes {df.kernel, input_depth = [0, 0, 0], output_depth = []} {
    call @transpose_matmul_with_scale_bf16(%arg0, %arg1, %arg2) : (memref<32x64xbf16>, memref<32x64xbf16>, memref<32x32xbf16>) -> ()
    return
  }
  func.func @core_1_0(%arg0: memref<32x64xbf16>, %arg1: memref<32x64xbf16>, %arg2: memref<32x32xbf16>) attributes {df.kernel, input_depth = [0, 0, 0], output_depth = []} {
    call @transpose_matmul_with_scale_bf16(%arg0, %arg1, %arg2) : (memref<32x64xbf16>, memref<32x64xbf16>, memref<32x32xbf16>) -> ()
    return
  }
  func.func @core_1_1(%arg0: memref<32x64xbf16>, %arg1: memref<32x64xbf16>, %arg2: memref<32x32xbf16>) attributes {df.kernel, input_depth = [0, 0, 0], output_depth = []} {
    call @transpose_matmul_with_scale_bf16(%arg0, %arg1, %arg2) : (memref<32x64xbf16>, memref<32x64xbf16>, memref<32x32xbf16>) -> ()
    return
  }
