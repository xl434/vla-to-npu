module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_5(%mem_tile_1_1, {%tile_0_3, %tile_2_3, %tile_1_3, %tile_3_3}, 2 : i32) : !aie.objectfifo<memref<768xbf16>> 
    aie.objectfifo @fifo_6(%shim_noc_tile_1_0, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<1x1x1x768xbf16>> 
    aie.objectfifo @fifo_7(%mem_tile_2_1, {%tile_1_2, %tile_0_2, %tile_2_2, %tile_3_2}, 2 : i32) : !aie.objectfifo<memref<768xbf16>> 
