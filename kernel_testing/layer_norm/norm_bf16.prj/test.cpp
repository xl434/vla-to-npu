...
int main(int argc, const char *argv[]) {
  ...
  auto bo_in0 = xrt::bo(device, 13056 * sizeof(std::bfloat16_t),
  ...
  if (ifile0_size != 12288 * sizeof(std::bfloat16_t)) {
    std::cerr << "Error: Invalid input file, byte number mismatch.\n";
    return 1;
  }
  std::vector<std::bfloat16_t> vec0(12288);
  ifile0.read(reinterpret_cast<char*>(vec0.data()), 12288 * sizeof(std::bfloat16_t));
  ...
  auto bo_out1 = xrt::bo(device, 12288 * sizeof(std::bfloat16_t),
  ...
  ofile3.write(reinterpret_cast<const char*>(bufOut1 + 0), 12288 * sizeof(std::bfloat16_t));
  ofile3.close();
  ifile1.close();
  if (trace_size > 0) {
