...
try:
    mod = df.build(rope_single, target="aie", project="single.prj")
    print("  PASS")
...
try:
    mod = df.build(rope_2head, target="aie", project="two.prj")
    print("  PASS")
except Exception as e:
    print(f"  FAIL: {e}")
...
try:
    mod = df.build(rope_4head, target="aie", project="four.prj")
    print("  PASS")
except Exception as e:
    print(f"  FAIL: {e}")
...
try:
    mod = df.build(rope_5head, target="aie", project="five.prj")
    print("  PASS")
except Exception as e:
    print(f"  FAIL: {e}")
...
try:
    mod = df.build(rope_8head, target="aie", project="eight.prj")
    print("  PASS")
except Exception as e:
    print(f"  FAIL: {e}")
...
try:
    mod = df.build(rope_15head, target="aie", project="fifteen.prj")
    print("  PASS")
except Exception as e:
    print(f"  FAIL: {e}")
...
try:
    mod = df.build(rope_9head, target="aie", project="nine.prj")
    print("  PASS")
except Exception as e:
    print(f"  FAIL: {e}")
...
try:
    mod = df.build(rope_10head, target="aie", project="ten.prj")
    print("  PASS")
except Exception as e:
    print(f"  FAIL: {e}")
...
try:
    mod = df.build(rope_12head, target="aie", project="twelve.prj")
    print("  PASS")
except Exception as e:
    print(f"  FAIL: {e}")
...
try:
    mod = df.build(rope_11head, target="aie", project="eleven.prj")
    print("  PASS")
except Exception as e:
    print(f"  FAIL: {e}")
