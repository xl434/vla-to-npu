...
int main(int argc, const char *argv[]) {
  ...
  auto bo_in2 = xrt::bo(device, 256 * sizeof(std::bfloat16_t),
  ...
  if (ifile1_size != 256 * sizeof(std::bfloat16_t)) {
    std::cerr << "Error: Invalid input file, byte number mismatch.\n";
    return 1;
  }
  std::vector<std::bfloat16_t> vec1(256);
  ifile1.read(reinterpret_cast<char*>(vec1.data()), 256 * sizeof(std::bfloat16_t));
