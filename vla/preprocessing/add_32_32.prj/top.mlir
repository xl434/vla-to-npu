module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_0(%mem_tile_0_1, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<32x32xbf16>> 
    aie.objectfifo @fifo_1(%shim_noc_tile_0_0, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<1x1x32x32xbf16>> 
    aie.objectfifo @fifo_2(%mem_tile_1_1, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<32x32xbf16>> 
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        %0 = aie.objectfifo.acquire @fifo_0(Consume, 1) : !aie.objectfifosubview<memref<32x32xbf16>>
        ...
        %4 = aie.objectfifo.acquire @fifo_4(Produce, 1) : !aie.objectfifosubview<memref<32x32xbf16>>
        %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<32x32xbf16>> -> memref<32x32xbf16>
        func.call @add(%1, %3, %5) : (memref<32x32xbf16>, memref<32x32xbf16>, memref<32x32xbf16>) -> ()
