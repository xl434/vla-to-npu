module {
  aie.device(npu1_4col) {
    memref.global "public" @fifo_5_cons : memref<1x1x32x32xbf16>
    memref.global "public" @fifo_5 : memref<1x1x32x32xbf16>
    memref.global "public" @fifo_4_cons : memref<32x32xbf16>
    memref.global "public" @fifo_4 : memref<32x32xbf16>
    memref.global "public" @fifo_3_cons : memref<1x1x32x32xbf16>
    memref.global "public" @fifo_3 : memref<1x1x32x32xbf16>
    memref.global "public" @fifo_2_cons : memref<32x32xbf16>
    memref.global "public" @fifo_2 : memref<32x32xbf16>
    memref.global "public" @fifo_1_cons : memref<1x1x32x32xbf16>
    memref.global "public" @fifo_1 : memref<1x1x32x32xbf16>
    memref.global "public" @fifo_0_cons : memref<32x32xbf16>
    memref.global "public" @fifo_0 : memref<32x32xbf16>
    ...
    %fifo_4_cons_buff_0 = aie.buffer(%mem_tile_2_1) {address = 0 : i32, sym_name = "fifo_4_cons_buff_0"} : memref<32x32xbf16> 
    %fifo_4_cons_buff_1 = aie.buffer(%mem_tile_2_1) {address = 2048 : i32, sym_name = "fifo_4_cons_buff_1"} : memref<32x32xbf16> 
    ...
    %fifo_4_buff_0 = aie.buffer(%tile_0_2) {address = 1024 : i32, sym_name = "fifo_4_buff_0"} : memref<32x32xbf16> 
    %fifo_4_buff_1 = aie.buffer(%tile_0_2) {address = 3072 : i32, sym_name = "fifo_4_buff_1"} : memref<32x32xbf16> 
    ...
    %fifo_3_cons_buff_0 = aie.buffer(%mem_tile_1_1) {address = 0 : i32, sym_name = "fifo_3_cons_buff_0"} : memref<1x1x32x32xbf16> 
    %fifo_3_cons_buff_1 = aie.buffer(%mem_tile_1_1) {address = 2048 : i32, sym_name = "fifo_3_cons_buff_1"} : memref<1x1x32x32xbf16> 
    ...
    %fifo_2_cons_buff_0 = aie.buffer(%tile_0_2) {address = 5120 : i32, sym_name = "fifo_2_cons_buff_0"} : memref<32x32xbf16> 
    %fifo_2_cons_buff_1 = aie.buffer(%tile_0_2) {address = 7168 : i32, sym_name = "fifo_2_cons_buff_1"} : memref<32x32xbf16> 
    ...
    %fifo_1_cons_buff_0 = aie.buffer(%mem_tile_0_1) {address = 0 : i32, sym_name = "fifo_1_cons_buff_0"} : memref<1x1x32x32xbf16> 
    %fifo_1_cons_buff_1 = aie.buffer(%mem_tile_0_1) {address = 2048 : i32, sym_name = "fifo_1_cons_buff_1"} : memref<1x1x32x32xbf16> 
    ...
    %fifo_0_cons_buff_0 = aie.buffer(%tile_0_2) {address = 9216 : i32, sym_name = "fifo_0_cons_buff_0"} : memref<32x32xbf16> 
    %fifo_0_cons_buff_1 = aie.buffer(%tile_0_2) {address = 11264 : i32, sym_name = "fifo_0_cons_buff_1"} : memref<32x32xbf16> 
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @add(%fifo_0_cons_buff_0, %fifo_2_cons_buff_0, %fifo_4_buff_0) : (memref<32x32xbf16>, memref<32x32xbf16>, memref<32x32xbf16>) -> ()
      ...
      aie.use_lock(%fifo_2_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%fifo_4_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @add(%fifo_0_cons_buff_1, %fifo_2_cons_buff_1, %fifo_4_buff_1) : (memref<32x32xbf16>, memref<32x32xbf16>, memref<32x32xbf16>) -> ()
      aie.use_lock(%fifo_0_cons_prod_lock_0, Release, 1)
      aie.use_lock(%fifo_2_cons_prod_lock_0, Release, 1)
      aie.use_lock(%fifo_4_cons_lock_0, Release, 1)
    ...
    aiex.runtime_sequence(%arg0: memref<1024xbf16>, %arg1: memref<1024xbf16>, %arg2: memref<1024xbf16>) {
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 1, 32, 32][0, 0, 32, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_1} : memref<1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][1, 1, 32, 32][0, 0, 32, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_3} : memref<1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][1, 1, 32, 32][0, 0, 32, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_5} : memref<1024xbf16>
