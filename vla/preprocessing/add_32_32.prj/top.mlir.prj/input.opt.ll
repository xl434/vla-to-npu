; ModuleID = '/home/dl2239/vla-to-npu/vla/preprocessing/add_32_32.prj/top.mlir.prj/input.llpeanohack.ll'
...
declare void @add(ptr, ptr, ptr) local_unnamed_addr
...
1:                                                ; preds = %0, %1
  ...
  tail call void @add(ptr nonnull @fifo_0_cons_buff_0, ptr nonnull @fifo_2_cons_buff_0, ptr nonnull @fifo_4_buff_0)
  ...
  tail call void @add(ptr nonnull @fifo_0_cons_buff_1, ptr nonnull @fifo_2_cons_buff_1, ptr nonnull @fifo_4_buff_1)
  tail call void @llvm.aie2.release(i32 48, i32 1)
  tail call void @llvm.aie2.release(i32 50, i32 1)
  tail call void @llvm.aie2.release(i32 53, i32 1)
