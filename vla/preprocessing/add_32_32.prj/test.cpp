...
int main(int argc, const char *argv[]) {
  ...
  auto bo_in2 = xrt::bo(device, 1024 * sizeof(std::bfloat16_t),
  ...
  if (ifile1_size != 1024 * sizeof(std::bfloat16_t)) {
    std::cerr << "Error: Invalid input file, byte number mismatch.\n";
    return 1;
  }
  std::vector<std::bfloat16_t> vec1(1024);
  ifile1.read(reinterpret_cast<char*>(vec1.data()), 1024 * sizeof(std::bfloat16_t));
