...
sin_cos_mod = df.build(
    sin_cos_region,
    target="aie",
    project="rope/sin_cos.prj",
)

copyL_mod = df.build(
    copy_left_region,
    target="aie",
    project="rope/copyL.prj",
)

copyR_mod = df.build(
    copy_right_region,
    target="aie",
    project="rope/copyR.prj",
)

join_mod = df.build(
    join_region,
    target="aie",
    project="rope/join.prj",
)

mul32_mod = df.build(
    mul32_region,
    target="aie",
    project="rope/mul32.prj",
)

add32_mod = df.build(
    add32_region,
    target="aie",
    project="rope/add32.prj",
)

sub32_mod = df.build(
    sub32_region,
    target="aie",
    project="rope/sub32.prj",
)
