...
int main(int argc, const char *argv[]) {
  ...
  auto bo_in0 = xrt::bo(device, 30720 * sizeof(std::bfloat16_t),
  ...
  if (ifile0_size != 30720 * sizeof(std::bfloat16_t)) {
    std::cerr << "Error: Invalid input file, byte number mismatch.\n";
    return 1;
  }
  std::vector<std::bfloat16_t> vec0(30720);
  ifile0.read(reinterpret_cast<char*>(vec0.data()), 30720 * sizeof(std::bfloat16_t));
  ...
  auto bo_in2 = xrt::bo(device, 737280 * sizeof(std::bfloat16_t),
  ...
  if (ifile1_size != 737280 * sizeof(std::bfloat16_t)) {
    std::cerr << "Error: Invalid input file, byte number mismatch.\n";
    return 1;
  }
  std::vector<std::bfloat16_t> vec1(737280);
  ifile1.read(reinterpret_cast<char*>(vec1.data()), 737280 * sizeof(std::bfloat16_t));
  ...
  ofile2.write(reinterpret_cast<const char*>(bufOut1 + 0), 24576 * sizeof(std::bfloat16_t));
  ofile2.close();
  ifile1.close();
  if (trace_size > 0) {
