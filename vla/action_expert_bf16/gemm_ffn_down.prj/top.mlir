module {
  aie.device(npu1_4col) {
    ...
    aiex.runtime_sequence(%arg0: memref<8192xbf16>, %arg1: memref<24576xbf16>, %arg2: memref<196608xbf16>) {
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 4, 32, 64][8192, 64, 256, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_1} : memref<8192xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 4, 32, 64][8192, 64, 256, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_1} : memref<8192xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 4, 32, 64][8192, 64, 256, 1]) {id = 8 : i64, issue_token = true, metadata = @fifo_1} : memref<8192xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][1, 4, 64, 64][64, 49152, 768, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_3} : memref<196608xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[4, 0, 0, 0][1, 4, 64, 64][64, 49152, 768, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_3} : memref<196608xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[8, 0, 0, 0][1, 4, 64, 64][64, 49152, 768, 1]) {id = 6 : i64, issue_token = true, metadata = @fifo_3} : memref<196608xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[1, 0, 0, 0][1, 4, 64, 64][64, 49152, 768, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_5} : memref<196608xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[5, 0, 0, 0][1, 4, 64, 64][64, 49152, 768, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_5} : memref<196608xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[9, 0, 0, 0][1, 4, 64, 64][64, 49152, 768, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_5} : memref<196608xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[2, 0, 0, 0][1, 4, 64, 64][64, 49152, 768, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_7} : memref<196608xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[6, 0, 0, 0][1, 4, 64, 64][64, 49152, 768, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_7} : memref<196608xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[10, 0, 0, 0][1, 4, 64, 64][64, 49152, 768, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_7} : memref<196608xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[3, 0, 0, 0][1, 4, 64, 64][64, 49152, 768, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_9} : memref<196608xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[7, 0, 0, 0][1, 4, 64, 64][64, 49152, 768, 1]) {id = 5 : i64, issue_token = true, metadata = @fifo_9} : memref<196608xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[11, 0, 0, 0][1, 4, 64, 64][64, 49152, 768, 1]) {id = 9 : i64, issue_token = true, metadata = @fifo_9} : memref<196608xbf16>
