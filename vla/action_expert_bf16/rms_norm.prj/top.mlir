module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_3(%mem_tile_1_1, {%tile_1_2}, 2 : i32) : !aie.objectfifo<memref<4x768xbf16>> 
    aie.objectfifo @fifo_4(%mem_tile_1_1, {%tile_1_3}, 2 : i32) : !aie.objectfifo<memref<4x768xbf16>> 
    aie.objectfifo @fifo_5(%shim_noc_tile_1_0, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<1x2x4x768xbf16>> 
    aie.objectfifo @fifo_6(%mem_tile_2_1, {%tile_2_2}, 2 : i32) : !aie.objectfifo<memref<4x768xbf16>> 
    aie.objectfifo @fifo_7(%mem_tile_2_1, {%tile_2_3}, 2 : i32) : !aie.objectfifo<memref<4x768xbf16>> 
    ...
    aie.objectfifo @fifo_12(%mem_tile_0_1, {%tile_1_3, %tile_1_2, %tile_0_3, %tile_3_2, %tile_3_3, %tile_2_3, %tile_2_2, %tile_0_2}, 2 : i32) : !aie.objectfifo<memref<768xbf16>> 
    ...
    aie.objectfifo @fifo_16(%mem_tile_0_1, {%shim_noc_tile_0_0}, 2 : i32) : !aie.objectfifo<memref<1x2x4x768xbf16>> 
    aie.objectfifo @fifo_17(%tile_1_2, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<4x768xbf16>> 
    aie.objectfifo @fifo_18(%tile_1_3, {%mem_tile_1_1}, 2 : i32) : !aie.objectfifo<memref<4x768xbf16>> 
    aie.objectfifo @fifo_19(%mem_tile_1_1, {%shim_noc_tile_0_0}, 2 : i32) : !aie.objectfifo<memref<1x2x4x768xbf16>> 
    aie.objectfifo @fifo_20(%tile_2_2, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<4x768xbf16>> 
    aie.objectfifo @fifo_21(%tile_2_3, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<4x768xbf16>> 
    aie.objectfifo @fifo_22(%mem_tile_2_1, {%shim_noc_tile_1_0}, 2 : i32) : !aie.objectfifo<memref<1x2x4x768xbf16>> 
    aie.objectfifo @fifo_23(%tile_3_2, {%mem_tile_3_1}, 2 : i32) : !aie.objectfifo<memref<4x768xbf16>> 
    aie.objectfifo @fifo_24(%tile_3_3, {%mem_tile_3_1}, 2 : i32) : !aie.objectfifo<memref<4x768xbf16>> 
    aie.objectfifo @fifo_25(%mem_tile_3_1, {%shim_noc_tile_1_0}, 2 : i32) : !aie.objectfifo<memref<1x2x4x768xbf16>> 
    aie.objectfifo.link [@fifo_2] -> [@fifo_0, @fifo_1]([] [0, 3072])
    aie.objectfifo.link [@fifo_13] -> [@fifo_12]([] [])
    aie.objectfifo.link [@fifo_14, @fifo_15] -> [@fifo_16]([0, 3072] [])
    aie.objectfifo.link [@fifo_5] -> [@fifo_3, @fifo_4]([] [0, 3072])
    aie.objectfifo.link [@fifo_17, @fifo_18] -> [@fifo_19]([0, 3072] [])
    aie.objectfifo.link [@fifo_8] -> [@fifo_6, @fifo_7]([] [0, 3072])
    aie.objectfifo.link [@fifo_20, @fifo_21] -> [@fifo_22]([0, 3072] [])
    aie.objectfifo.link [@fifo_11] -> [@fifo_9, @fifo_10]([] [0, 3072])
    aie.objectfifo.link [@fifo_23, @fifo_24] -> [@fifo_25]([0, 3072] [])
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %2 = aie.objectfifo.acquire @fifo_12(Consume, 1) : !aie.objectfifosubview<memref<768xbf16>>
    ...
    %core_1_3 = aie.core(%tile_1_3) {
      ...
      %c9223372036854775807 = arith.constant 9223372036854775807 : index
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        %0 = aie.objectfifo.acquire @fifo_4(Consume, 1) : !aie.objectfifosubview<memref<4x768xbf16>>
        %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<4x768xbf16>> -> memref<4x768xbf16>
        %2 = aie.objectfifo.acquire @fifo_12(Consume, 1) : !aie.objectfifosubview<memref<768xbf16>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<768xbf16>> -> memref<768xbf16>
    ...
    %core_3_2 = aie.core(%tile_3_2) {
      ...
      %c9223372036854775807 = arith.constant 9223372036854775807 : index
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        %0 = aie.objectfifo.acquire @fifo_9(Consume, 1) : !aie.objectfifosubview<memref<4x768xbf16>>
        %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<4x768xbf16>> -> memref<4x768xbf16>
        %2 = aie.objectfifo.acquire @fifo_12(Consume, 1) : !aie.objectfifosubview<memref<768xbf16>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<768xbf16>> -> memref<768xbf16>
    ...
    aiex.runtime_sequence(%arg0: memref<24576xbf16>, %arg1: memref<24576xbf16>, %arg2: memref<768xbf16>) {
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 2, 4, 768][0, 3072, 768, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_2} : memref<24576xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 2, 0, 0][1, 2, 4, 768][0, 3072, 768, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_5} : memref<24576xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 4, 0, 0][1, 2, 4, 768][0, 3072, 768, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_8} : memref<24576xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 6, 0, 0][1, 2, 4, 768][0, 3072, 768, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_11} : memref<24576xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][1, 1, 1, 768][0, 0, 0, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_13} : memref<768xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][1, 2, 4, 768][0, 3072, 768, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_16} : memref<24576xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 2, 0, 0][1, 2, 4, 768][0, 3072, 768, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_19} : memref<24576xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 4, 0, 0][1, 2, 4, 768][0, 3072, 768, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_22} : memref<24576xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 6, 0, 0][1, 2, 4, 768][0, 3072, 768, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_25} : memref<24576xbf16>
