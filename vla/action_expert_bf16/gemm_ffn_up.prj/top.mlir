module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_0(%mem_tile_0_1 dimensionsToStream [<size = 8, stride = 256>, <size = 8, stride = 8>, <size = 4, stride = 64>, <size = 8, stride = 1>], {%tile_0_3, %tile_0_4, %tile_0_5, %tile_0_2}, 2 : i32) : !aie.objectfifo<memref<32x64xbf16>> 
    ...
    aiex.runtime_sequence(%arg0: memref<24576xbf16>, %arg1: memref<65536xbf16>, %arg2: memref<1572864xbf16>) {
      ...
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 12, 32, 64][24576, 64, 768, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_1} : memref<24576xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 12, 32, 64][24576, 64, 768, 1]) {id = 8 : i64, issue_token = true, metadata = @fifo_1} : memref<24576xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 12, 32, 64][24576, 64, 768, 1]) {id = 12 : i64, issue_token = true, metadata = @fifo_1} : memref<24576xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_3} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[4, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_3} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[8, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 6 : i64, issue_token = true, metadata = @fifo_3} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[12, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 9 : i64, issue_token = true, metadata = @fifo_3} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[1, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_5} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[5, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_5} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[9, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_5} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[13, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_5} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[2, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_7} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[6, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_7} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[10, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_7} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[14, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_7} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[3, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_9} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[7, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 5 : i64, issue_token = true, metadata = @fifo_9} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[11, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 9 : i64, issue_token = true, metadata = @fifo_9} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[15, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 13 : i64, issue_token = true, metadata = @fifo_9} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_11} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 4, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 6 : i64, issue_token = true, metadata = @fifo_11} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 8, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 10 : i64, issue_token = true, metadata = @fifo_11} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 12, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 14 : i64, issue_token = true, metadata = @fifo_11} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 1, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_13} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 5, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 7 : i64, issue_token = true, metadata = @fifo_13} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 9, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 11 : i64, issue_token = true, metadata = @fifo_13} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 13, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 15 : i64, issue_token = true, metadata = @fifo_13} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 2, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_15} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 6, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_15} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 10, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 7 : i64, issue_token = true, metadata = @fifo_15} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 14, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 10 : i64, issue_token = true, metadata = @fifo_15} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 3, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_17} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 7, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 5 : i64, issue_token = true, metadata = @fifo_17} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 11, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 8 : i64, issue_token = true, metadata = @fifo_17} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 15, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 11 : i64, issue_token = true, metadata = @fifo_17} : memref<65536xbf16>
      ...
      aiex.npu.dma_memcpy_nd(%arg2[16, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 12 : i64, issue_token = true, metadata = @fifo_3} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[17, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_5} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[18, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_7} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[19, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_9} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 16, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_11} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 17, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_13} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 18, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 13 : i64, issue_token = true, metadata = @fifo_15} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 19, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 14 : i64, issue_token = true, metadata = @fifo_17} : memref<65536xbf16>
      aiex.npu.dma_wait {symbol = @fifo_11}
      aiex.npu.dma_wait {symbol = @fifo_13}
      aiex.npu.dma_wait {symbol = @fifo_15}
      aiex.npu.dma_wait {symbol = @fifo_17}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 12, 32, 64][24576, 64, 768, 1]) {id = 7 : i64, issue_token = true, metadata = @fifo_1} : memref<24576xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[20, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 15 : i64, issue_token = true, metadata = @fifo_3} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[21, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 5 : i64, issue_token = true, metadata = @fifo_5} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[22, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 5 : i64, issue_token = true, metadata = @fifo_7} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[23, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_9} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 20, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 5 : i64, issue_token = true, metadata = @fifo_11} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 21, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 6 : i64, issue_token = true, metadata = @fifo_13} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 22, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_15} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 23, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_17} : memref<65536xbf16>
      aiex.npu.dma_wait {symbol = @fifo_11}
      aiex.npu.dma_wait {symbol = @fifo_13}
      aiex.npu.dma_wait {symbol = @fifo_15}
      aiex.npu.dma_wait {symbol = @fifo_17}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 12, 32, 64][24576, 64, 768, 1]) {id = 11 : i64, issue_token = true, metadata = @fifo_1} : memref<24576xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[24, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_3} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[25, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 6 : i64, issue_token = true, metadata = @fifo_5} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[26, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 6 : i64, issue_token = true, metadata = @fifo_7} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[27, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 10 : i64, issue_token = true, metadata = @fifo_9} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 24, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 9 : i64, issue_token = true, metadata = @fifo_11} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 25, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 8 : i64, issue_token = true, metadata = @fifo_13} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 26, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_15} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 27, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_17} : memref<65536xbf16>
      aiex.npu.dma_wait {symbol = @fifo_11}
      aiex.npu.dma_wait {symbol = @fifo_13}
      aiex.npu.dma_wait {symbol = @fifo_15}
      aiex.npu.dma_wait {symbol = @fifo_17}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 12, 32, 64][24576, 64, 768, 1]) {id = 14 : i64, issue_token = true, metadata = @fifo_1} : memref<24576xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[28, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 5 : i64, issue_token = true, metadata = @fifo_3} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[29, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 7 : i64, issue_token = true, metadata = @fifo_5} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[30, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 7 : i64, issue_token = true, metadata = @fifo_7} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[31, 0, 0, 0][1, 12, 64, 64][64, 131072, 2048, 1]) {id = 15 : i64, issue_token = true, metadata = @fifo_9} : memref<1572864xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 28, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 13 : i64, issue_token = true, metadata = @fifo_11} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 29, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 12 : i64, issue_token = true, metadata = @fifo_13} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 30, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 6 : i64, issue_token = true, metadata = @fifo_15} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 31, 0, 0][1, 1, 32, 64][65536, 64, 2048, 1]) {id = 8 : i64, issue_token = true, metadata = @fifo_17} : memref<65536xbf16>
      aiex.npu.dma_wait {symbol = @fifo_11}
      aiex.npu.dma_wait {symbol = @fifo_13}
      aiex.npu.dma_wait {symbol = @fifo_15}
      aiex.npu.dma_wait {symbol = @fifo_17}
