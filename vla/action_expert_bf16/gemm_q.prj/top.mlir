module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_2(%mem_tile_1_1 dimensionsToStream [<size = 8, stride = 256>, <size = 8, stride = 8>, <size = 4, stride = 64>, <size = 8, stride = 1>], {%tile_1_4, %tile_1_2, %tile_1_3}, 2 : i32) : !aie.objectfifo<memref<32x64xbf16>> 
