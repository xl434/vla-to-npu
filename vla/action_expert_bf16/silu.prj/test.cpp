...
int main(int argc, const char *argv[]) {
  ...
  ofile1.write(reinterpret_cast<const char*>(bufOut1 + 0), 32768 * sizeof(std::bfloat16_t));
  ofile1.close();
  if (trace_size > 0) {
