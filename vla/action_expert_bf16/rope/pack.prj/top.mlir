module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_0(%mem_tile_0_1, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<64x32xf32>> 
    aie.objectfifo @fifo_1(%shim_noc_tile_0_0, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<1x1x64x32xf32>> 
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        %0 = aie.objectfifo.acquire @fifo_0(Consume, 1) : !aie.objectfifosubview<memref<64x32xf32>>
        ...
        func.call @pack32to64_float32(%1, %3) : (memref<64x32xf32>, memref<64x64xf32>) -> ()
    ...
    aiex.runtime_sequence(%arg0: memref<2048xf32>, %arg1: memref<4096xf32>) {
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 1, 64, 32][2048, 32, 32, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_1} : memref<2048xf32>
