module {
  ...
  func.func @core_0_1(%arg0: memref<32x64xf32>, %arg1: memref<32x64xf32>) attributes {df.kernel, input_depth = [0, 0], output_depth = []} {
    call @cos_float32(%arg0, %arg1) : (memref<32x64xf32>, memref<32x64xf32>) -> ()
    return
  }
  func.func @cos_region(%arg0: memref<64x64xf32>, %arg1: memref<64x64xf32>) attributes {dataflow, itypes = "__"} {
    return
  }
}
