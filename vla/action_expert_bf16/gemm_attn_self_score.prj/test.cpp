...
int main(int argc, const char *argv[]) {
  ...
  auto bo_in0 = xrt::bo(device, 2048 * sizeof(std::bfloat16_t),
  ...
  auto bo_in2 = xrt::bo(device, 2048 * sizeof(std::bfloat16_t),
  ...
  if (ifile1_size != 2048 * sizeof(std::bfloat16_t)) {
    std::cerr << "Error: Invalid input file, byte number mismatch.\n";
    return 1;
  }
  std::vector<std::bfloat16_t> vec1(2048);
  ifile1.read(reinterpret_cast<char*>(vec1.data()), 2048 * sizeof(std::bfloat16_t));
