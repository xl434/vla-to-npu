module {
  aie.device(npu1_4col) {
    ...
    aiex.runtime_sequence(%arg0: memref<2048xbf16>, %arg1: memref<1024xbf16>, %arg2: memref<2048xbf16>) {
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 2, 32, 32][2048, 32, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_1} : memref<2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][1, 2, 32, 32][32, 1024, 32, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_3} : memref<2048xbf16>
