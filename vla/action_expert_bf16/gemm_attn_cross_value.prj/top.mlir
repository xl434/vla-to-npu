  ...
  aie.device(npu1_4col) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        aie.objectfifo.release @fifo_2(Consume, 1)
        %12 = aie.objectfifo.acquire @fifo_2(Consume, 1) : !aie.objectfifosubview<memref<32x32xbf16>>
        ...
        aie.objectfifo.release @fifo_2(Consume, 1)
        %16 = aie.objectfifo.acquire @fifo_2(Consume, 1) : !aie.objectfifosubview<memref<32x32xbf16>>
    ...
    %core_0_3 = aie.core(%tile_0_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %11 = aie.objectfifo.subview.access %10[0] : !aie.objectfifosubview<memref<32x32xbf16>> -> memref<32x32xbf16>
        aie.objectfifo.release @fifo_4(Consume, 1)
        %12 = aie.objectfifo.acquire @fifo_4(Consume, 1) : !aie.objectfifosubview<memref<32x32xbf16>>
        %13 = aie.objectfifo.subview.access %12[0] : !aie.objectfifosubview<memref<32x32xbf16>> -> memref<32x32xbf16>
        func.call @matmul_bf16_bf16(%11, %13, %1) : (memref<32x32xbf16>, memref<32x32xbf16>, memref<32x32xbf16>) -> ()
        aie.objectfifo.release @fifo_0(Consume, 1)
        %14 = aie.objectfifo.acquire @fifo_0(Consume, 1) : !aie.objectfifosubview<memref<32x32xbf16>>
        %15 = aie.objectfifo.subview.access %14[0] : !aie.objectfifosubview<memref<32x32xbf16>> -> memref<32x32xbf16>
        aie.objectfifo.release @fifo_4(Consume, 1)
        %16 = aie.objectfifo.acquire @fifo_4(Consume, 1) : !aie.objectfifosubview<memref<32x32xbf16>>
        %17 = aie.objectfifo.subview.access %16[0] : !aie.objectfifosubview<memref<32x32xbf16>> -> memref<32x32xbf16>
        func.call @matmul_bf16_bf16(%15, %17, %1) : (memref<32x32xbf16>, memref<32x32xbf16>, memref<32x32xbf16>) -> ()
        aie.objectfifo.release @fifo_0(Consume, 1)
        aie.objectfifo.release @fifo_4(Consume, 1)
    ...
    aiex.runtime_sequence(%arg0: memref<4096xbf16>, %arg1: memref<2048xbf16>, %arg2: memref<8192xbf16>) {
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 4, 32, 32][4096, 32, 128, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_1} : memref<4096xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][1, 4, 32, 32][32, 2048, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_3} : memref<8192xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[1, 0, 0, 0][1, 4, 32, 32][32, 2048, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_5} : memref<8192xbf16>
