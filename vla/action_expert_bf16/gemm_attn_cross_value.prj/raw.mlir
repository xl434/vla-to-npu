module {
  ...
  func.func @gemm_1_0_0(%arg0: memref<32x32xbf16>, %arg1: memref<32x32xbf16>, %arg2: memref<32x32xbf16>, %arg3: !allo.stream<memref<32x32xbf16>, 2>, %arg4: !allo.stream<memref<32x32xbf16>, 2>) attributes {df.kernel, itypes = "_____", otypes = "", stypes = "___io", tag = "gemm_((), None, (), None)"} {
    %cst = arith.constant 0.000000e+00 : bf16
    %alloc = memref.alloc() {name = "C_in"} : memref<32x32xbf16>
  ...
  func.func @gemm_3_0_0(%arg0: memref<32x32xbf16>, %arg1: memref<32x32xbf16>, %arg2: memref<32x32xbf16>, %arg3: !allo.stream<memref<32x32xbf16>, 2>) attributes {df.kernel, itypes = "____", otypes = "", stypes = "___i", tag = "gemm_((), None, None, ())"} {
    %cst = arith.constant 0.000000e+00 : bf16
    %alloc = memref.alloc() {name = "C_in"} : memref<32x32xbf16>
    %0 = allo.stream_get(%arg3, []) : !allo.stream<memref<32x32xbf16>, 2> -> memref<32x32xbf16>
    memref.copy %0, %alloc {to = "C_in"} : memref<32x32xbf16> to memref<32x32xbf16>
