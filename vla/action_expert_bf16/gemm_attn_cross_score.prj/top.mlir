module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_0(%mem_tile_0_1 dimensionsToStream [<size = 8, stride = 128>, <size = 4, stride = 8>, <size = 4, stride = 32>, <size = 8, stride = 1>], {%tile_0_4, %tile_0_5, %tile_0_2, %tile_0_3}, 2 : i32) : !aie.objectfifo<memref<32x32xbf16>> 
