module {
  ...
  func.func @gemm_0_0(%arg0: memref<16x64xf32>, %arg1: memref<64x16xf32>, %arg2: memref<16x16xf32>) attributes {df.kernel, itypes = "___", otypes = "", stypes = "___", tag = "gemm_()"} {
    call @fill_zeros_f32_16_16_vector(%arg2) {lib = "fill_zeros_f32_16_16_vector"} : (memref<16x16xf32>) -> ()
    linalg.matmul {op_name = "matmul_1"} ins(%arg0, %arg1 : memref<16x64xf32>, memref<64x16xf32>) outs(%arg2 : memref<16x16xf32>)
    return
  }
