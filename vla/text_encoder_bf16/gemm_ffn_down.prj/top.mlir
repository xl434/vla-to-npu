module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_0(%mem_tile_0_1 dimensionsToStream [<size = 16, stride = 256>, <size = 8, stride = 8>, <size = 4, stride = 64>, <size = 8, stride = 1>], {%tile_0_3, %tile_0_2, %tile_0_4}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    ...
    aie.objectfifo @fifo_3(%mem_tile_1_1 dimensionsToStream [<size = 16, stride = 256>, <size = 8, stride = 8>, <size = 4, stride = 64>, <size = 8, stride = 1>], {%tile_1_4, %tile_1_5, %tile_2_2, %tile_2_3}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    aie.objectfifo @fifo_4(%mem_tile_1_1 dimensionsToStream [<size = 16, stride = 256>, <size = 8, stride = 8>, <size = 4, stride = 64>, <size = 8, stride = 1>], {%tile_3_4, %tile_3_3, %tile_3_2, %tile_3_5}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    ...
    aie.objectfifo @fifo_10(%mem_tile_3_1 dimensionsToStream [<size = 8, stride = 512>, <size = 16, stride = 4>, <size = 8, stride = 64>, <size = 4, stride = 1>], {%tile_1_4, %tile_3_2}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    ...
    aie.objectfifo @fifo_13(%mem_tile_3_1 dimensionsToStream [<size = 8, stride = 512>, <size = 16, stride = 4>, <size = 8, stride = 64>, <size = 4, stride = 1>], {%tile_3_5, %tile_2_3}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
    ...
    aiex.runtime_sequence(%arg0: memref<40960xbf16>, %arg1: memref<122880xbf16>, %arg2: memref<307200xbf16>) {
      ...
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][5, 2, 64, 64][64, 20480, 320, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_5} : memref<40960xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][5, 2, 64, 64][64, 20480, 320, 1]) {id = 6 : i64, issue_token = true, metadata = @fifo_5} : memref<40960xbf16>
