module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_6(%mem_tile_3_1 dimensionsToStream [<size = 8, stride = 512>, <size = 16, stride = 4>, <size = 8, stride = 64>, <size = 4, stride = 1>], {%tile_1_3, %tile_0_3}, 2 : i32) : !aie.objectfifo<memref<64x64xbf16>> 
