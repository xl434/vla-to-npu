module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_6(%tile_1_2, {%mem_tile_3_1}, 2 : i32) : !aie.objectfifo<memref<32x64xf32>> 
    aie.objectfifo @fifo_7(%mem_tile_3_1, {%shim_noc_tile_3_0}, 2 : i32) : !aie.objectfifo<memref<1x1x32x64xf32>> 
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %2 = aie.objectfifo.acquire @fifo_4(Produce, 1) : !aie.objectfifosubview<memref<32x64xf32>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<32x64xf32>> -> memref<32x64xf32>
        func.call @cos_float32(%1, %3) : (memref<32x64xf32>, memref<32x64xf32>) -> ()
    ...
    %core_1_2 = aie.core(%tile_1_2) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<32x64xf32>> -> memref<32x64xf32>
        %2 = aie.objectfifo.acquire @fifo_6(Produce, 1) : !aie.objectfifosubview<memref<32x64xf32>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<32x64xf32>> -> memref<32x64xf32>
        func.call @cos_float32(%1, %3) : (memref<32x64xf32>, memref<32x64xf32>) -> ()
    ...
    aiex.runtime_sequence(%arg0: memref<4096xf32>, %arg1: memref<4096xf32>) {
      ...
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][1, 1, 32, 64][2048, 64, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_5} : memref<4096xf32>
      aiex.npu.dma_memcpy_nd(%arg1[1, 0, 0, 0][1, 1, 32, 64][2048, 64, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_7} : memref<4096xf32>
