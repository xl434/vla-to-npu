...
int main(int argc, const char *argv[]) {
  ...
  auto bo_in0 = xrt::bo(device, 1024 * sizeof(float),
  ...
  if (ifile0_size != 1024 * sizeof(float)) {
    std::cerr << "Error: Invalid input file, byte number mismatch.\n";
    return 1;
  }
  std::vector<float> vec0(1024);
  ifile0.read(reinterpret_cast<char*>(vec0.data()), 1024 * sizeof(float));
  ...
  auto bo_in2 = xrt::bo(device, 1024 * sizeof(float),
  ...
  if (ifile1_size != 1024 * sizeof(float)) {
    std::cerr << "Error: Invalid input file, byte number mismatch.\n";
    return 1;
  }
  std::vector<float> vec1(1024);
  ifile1.read(reinterpret_cast<char*>(vec1.data()), 1024 * sizeof(float));
