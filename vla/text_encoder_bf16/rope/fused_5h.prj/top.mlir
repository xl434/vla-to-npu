module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_6(%mem_tile_1_1, {%tile_0_2}, 2 : i32) : !aie.objectfifo<memref<32x64xf32>> 
    aie.objectfifo @fifo_7(%mem_tile_1_1, {%tile_0_3}, 2 : i32) : !aie.objectfifo<memref<32x64xf32>> 
    aie.objectfifo @fifo_8(%mem_tile_1_1, {%tile_0_4}, 2 : i32) : !aie.objectfifo<memref<32x64xf32>> 
    aie.objectfifo @fifo_9(%mem_tile_1_1, {%tile_0_5}, 2 : i32) : !aie.objectfifo<memref<32x64xf32>> 
    ...
    aie.objectfifo @fifo_12(%tile_0_2, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<32x64xf32>> 
    aie.objectfifo @fifo_13(%tile_0_3, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<32x64xf32>> 
    aie.objectfifo @fifo_14(%tile_0_4, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<32x64xf32>> 
    aie.objectfifo @fifo_15(%tile_0_5, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<32x64xf32>> 
    aie.objectfifo @fifo_16(%tile_1_2, {%mem_tile_2_1}, 2 : i32) : !aie.objectfifo<memref<32x64xf32>> 
    aie.objectfifo @fifo_17(%mem_tile_2_1, {%shim_noc_tile_2_0}, 2 : i32) : !aie.objectfifo<memref<5x1x32x64xf32>> 
    ...
    aie.objectfifo.link [@fifo_12, @fifo_13, @fifo_14, @fifo_15, @fifo_16] -> [@fifo_17]([0, 2048, 4096, 6144, 8192] [])
    ...
    %core_0_3 = aie.core(%tile_0_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<32x64xf32>> -> memref<32x64xf32>
        %2 = aie.objectfifo.acquire @fifo_7(Consume, 1) : !aie.objectfifosubview<memref<32x64xf32>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<32x64xf32>> -> memref<32x64xf32>
    ...
    %core_0_5 = aie.core(%tile_0_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<32x64xf32>> -> memref<32x64xf32>
        %2 = aie.objectfifo.acquire @fifo_9(Consume, 1) : !aie.objectfifosubview<memref<32x64xf32>>
        %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<32x64xf32>> -> memref<32x64xf32>
    ...
    aiex.runtime_sequence(%arg0: memref<10240xf32>, %arg1: memref<10240xf32>, %arg2: memref<10240xf32>) {
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 5, 32, 64][64, 2048, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_5} : memref<10240xf32>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][1, 5, 32, 64][64, 2048, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_11} : memref<10240xf32>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][1, 5, 32, 64][64, 2048, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_17} : memref<10240xf32>
