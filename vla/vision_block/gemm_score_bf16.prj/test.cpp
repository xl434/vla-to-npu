...
int main(int argc, const char *argv[]) {
  ...
  auto bo_in0 = xrt::bo(device, 65536 * sizeof(std::bfloat16_t),
  ...
  auto bo_out1 = xrt::bo(device, 1048576 * sizeof(std::bfloat16_t),
  ...
  ofile2.write(reinterpret_cast<const char*>(bufOut1 + 0), 1048576 * sizeof(std::bfloat16_t));
  ofile2.close();
  ifile1.close();
  if (trace_size > 0) {
