...
int main(int argc, const char *argv[]) {
  ...
  auto bo_in0 = xrt::bo(device, 1048576 * sizeof(std::bfloat16_t),
  ...
  if (ifile0_size != 1048576 * sizeof(std::bfloat16_t)) {
    std::cerr << "Error: Invalid input file, byte number mismatch.\n";
    return 1;
  }
  std::vector<std::bfloat16_t> vec0(1048576);
  ifile0.read(reinterpret_cast<char*>(vec0.data()), 1048576 * sizeof(std::bfloat16_t));
