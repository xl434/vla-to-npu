module {
  aie.device(npu1_4col) {
    ...
    aie.objectfifo @fifo_8(%mem_tile_0_1 dimensionsToStream [<size = 8, stride = 256>, <size = 8, stride = 4>, <size = 8, stride = 32>, <size = 4, stride = 1>], {%tile_1_5, %tile_2_5, %tile_0_5, %tile_3_5}, 2 : i32) : !aie.objectfifo<memref<64x32xbf16>> 
    aie.objectfifo @fifo_9(%shim_noc_tile_0_0, {%mem_tile_0_1}, 2 : i32) : !aie.objectfifo<memref<1x1x64x32xbf16>> 
    aie.objectfifo @fifo_10(%mem_tile_0_1 dimensionsToStream [<size = 4, stride = 512>, <size = 16, stride = 4>, <size = 8, stride = 64>, <size = 4, stride = 1>], {%tile_0_2, %tile_3_2, %tile_1_2, %tile_2_2}, 2 : i32) : !aie.objectfifo<memref<32x64xbf16>> 
    ...
    %buffer_1_3_5 = aie.buffer(%tile_1_3) : memref<32xbf16> 
    %buffer_1_3_6 = aie.buffer(%tile_1_3) : memref<32x64xbf16> 
    %buffer_1_3_7 = aie.buffer(%tile_1_3) : memref<32xbf16> 
    %buffer_2_4 = aie.buffer(%tile_2_4) : memref<32xbf16> 
    %buffer_2_4_8 = aie.buffer(%tile_2_4) : memref<32x32xbf16> 
    %buffer_2_2 = aie.buffer(%tile_2_2) : memref<32x32xbf16> 
    %buffer_2_3 = aie.buffer(%tile_2_3) : memref<32x64xbf16> 
    %buffer_2_3_9 = aie.buffer(%tile_2_3) : memref<32xbf16> 
    %buffer_2_3_10 = aie.buffer(%tile_2_3) : memref<32x64xbf16> 
    %buffer_2_3_11 = aie.buffer(%tile_2_3) : memref<32xbf16> 
    %buffer_3_4 = aie.buffer(%tile_3_4) : memref<32xbf16> 
    %buffer_3_4_12 = aie.buffer(%tile_3_4) : memref<32x32xbf16> 
    ...
    aiex.runtime_sequence(%arg0: memref<131072xbf16>, %arg1: memref<65536xbf16>, %arg2: memref<65536xbf16>) {
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][8, 1, 32, 64][8192, 2048, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_1} : memref<131072xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 2048][8, 1, 32, 64][8192, 2048, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_3} : memref<131072xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 4096][8, 1, 32, 64][8192, 2048, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_5} : memref<131072xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 6144][8, 1, 32, 64][8192, 2048, 64, 1]) {id = 0 : i64, issue_token = true, metadata = @fifo_7} : memref<131072xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][8, 32, 64, 32][0, 32, 1024, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_9} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 65536][8, 32, 32, 64][0, 2048, 64, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_11} : memref<131072xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 1, 32, 64][8192, 2048, 64, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_13} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 2048][8, 1, 32, 64][8192, 2048, 64, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_15} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 4096][8, 1, 32, 64][8192, 2048, 64, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_17} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 6144][8, 1, 32, 64][8192, 2048, 64, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_19} : memref<65536xbf16>
