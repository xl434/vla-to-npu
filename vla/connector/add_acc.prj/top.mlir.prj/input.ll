...
4:                                                ; preds = %1
  ...
  call void @add_bf16_vector(ptr @fifo_0_cons_buff_0, ptr @fifo_2_cons_buff_0, ptr @fifo_4_buff_0)
  ...
  call void @add_bf16_vector(ptr @fifo_0_cons_buff_1, ptr @fifo_2_cons_buff_1, ptr @fifo_4_buff_1)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 50, i32 1)
  call void @llvm.aie2.release(i32 53, i32 1)
  %5 = add i64 %2, 2
