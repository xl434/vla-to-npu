module {
  aie.device(npu1_4col) {
    ...
    ^bb2:  // pred: ^bb1
      ...
      func.call @add_bf16_vector(%fifo_0_cons_buff_0, %fifo_2_cons_buff_0, %fifo_4_buff_0) {lib = "add_bf16_vector"} : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
      ...
      aie.use_lock(%fifo_2_cons_cons_lock_0, AcquireGreaterEqual, 1)
      aie.use_lock(%fifo_4_prod_lock_0, AcquireGreaterEqual, 1)
      func.call @add_bf16_vector(%fifo_0_cons_buff_1, %fifo_2_cons_buff_1, %fifo_4_buff_1) {lib = "add_bf16_vector"} : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
      aie.use_lock(%fifo_0_cons_prod_lock_0, Release, 1)
      aie.use_lock(%fifo_2_cons_prod_lock_0, Release, 1)
      aie.use_lock(%fifo_4_cons_lock_0, Release, 1)
