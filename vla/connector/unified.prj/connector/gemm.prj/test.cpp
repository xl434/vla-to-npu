...
int main(int argc, const char *argv[]) {
  ...
  auto bo_in2 = xrt::bo(device, 49152 * sizeof(std::bfloat16_t),
  ...
  if (ifile1_size != 49152 * sizeof(std::bfloat16_t)) {
    std::cerr << "Error: Invalid input file, byte number mismatch.\n";
    return 1;
  }
  std::vector<std::bfloat16_t> vec1(49152);
  ifile1.read(reinterpret_cast<char*>(vec1.data()), 49152 * sizeof(std::bfloat16_t));
  ...
  ofile2.write(reinterpret_cast<const char*>(bufOut1 + 0), 2048 * sizeof(std::bfloat16_t));
  ofile2.close();
  ifile1.close();
  if (trace_size > 0) {
