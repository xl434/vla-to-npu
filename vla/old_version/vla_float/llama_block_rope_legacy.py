...
# Legacy version: RoPE uses separate sine.cc and cosine.cc NPU kernels.
# Superseded by llama_block_rope_sin_cos.py which uses the combined sin_cos.cc kernel.
# Kept here because it retains debug print statements useful for NaN tracing.
