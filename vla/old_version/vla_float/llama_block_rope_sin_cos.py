...
# Updated version: RoPE uses the combined sin_cos.cc NPU kernel instead of
# separate sine.cc/cosine.cc. Debug prints removed. Replaces the original
# llama_block_rope_legacy.py. Both files are float32 reference implementations.
