 ...
 *
 * RMSNorm bf16 for HIDDEN=960 (SmolVLA text encoder)
 */
...
void rms_norm_960_bf16(bfloat16 A_in[4][960], bfloat16 B_in[960], bfloat16 C_out[4][960]) {
    rms_norm_single_batch<4, 960>(&A_in[0][0], B_in, &C_out[0][0]);
}
