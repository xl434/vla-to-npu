...
void silu_bfloat16_128(bfloat16 input_x[4][256], bfloat16 output_x[4][256]) {
  ...
  constexpr int FEATURE_DIM_TILE = 128;  // Only process first 128 columns
...
void silu_128_bf16(bfloat16 input_x[4][256], bfloat16 output_x[4][256]) {
    silu_bfloat16_128(input_x, output_x);
}
