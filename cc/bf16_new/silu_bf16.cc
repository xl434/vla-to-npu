...
// Conversion: bfloat16 -> float -> bfloat16 (small tile)
void silu_bfloat16_small(bfloat16 input_x[1][192], bfloat16 output_x[1][192]) {
  event0();
  constexpr int SEQ_TILE         = 1;
  constexpr int FEATURE_DIM_TILE = 192;
  constexpr int vec_factor       = 32;
...
void silu_bf16_small(bfloat16 input_x[1][192], bfloat16 output_x[1][192]) {
silu_bfloat16_small(input_x, output_x);
}
