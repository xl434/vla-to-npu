 ...
 *
 * RMSNorm float32 for HIDDEN=960 (SmolVLA text encoder)
 */
...
void rms_norm_960(float A_in[2][960], float B_in[960], float C_out[2][960]) {
    rms_norm_single_batch<float, float, 2, 960>(&A_in[0][0], B_in, &C_out[0][0]);
}
